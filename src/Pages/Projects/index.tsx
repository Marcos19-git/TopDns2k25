        ...
        <div className="w-full transition-all duration-300 flex justify-center items-center gap-[40px] flex-wrap pb-[200px]">
          <a href={contatos.imagem1.link} target="_blank" title="Yune Net">
            <img
              ...
              src={contatos.imagem1.imagem}
              style={{ maxWidth: "100%", maxHeight: "auto" }}
            ></img>
          </a>

          <a href={contatos.imagem2.link} target="_blank" title="Tw Speed">
            <img
              className="img2 p-[5px] rounded-[6px] bg-white"
              src={contatos.imagem2.imagem}
              style={{ maxWidth: "100%", maxHeight: "auto" }}
            ></img>
          </a>
          <a
            href={contatos.imagem3.link}
            target="_blank"
            title="Central do Assinante"
          >
            <img
              className="img3 p-[5px] rounded-[6px] bg-white"
              src={contatos.imagem3.imagem}
              style={{ maxWidth: "100%", maxHeight: "auto" }}
            ></img>
          </a>
          <a href={contatos.imagem4.link} target="_blank" title="Top Sapp">
            <img
              className="img4 p-[5px] rounded-[6px] bg-white"
              src={contatos.imagem4.imagem}
              style={{ maxWidth: "100%", maxHeight: "auto" }}
            ></img>
          </a>
          <a href={contatos.imagem5.link} target="_blank" title="Top Crm">
            <img
              className="img5 p-[5px] rounded-[6px] bg-white"
              src={contatos.imagem5.imagem}
              style={{ maxWidth: "100%", maxHeight: "auto" }}
            ></img>
          </a>
        </div>
